# Ccgonowdep Kotlin Multiplatform Library

A Kotlin Multiplatform wrapper for the Ccgonowdep native C++ library, enabling seamless integration across Android, iOS, and Desktop (JVM) platforms.
...
dependencies {
    ...
    implementation("com.mojeter.ccgo:ccgonowdep-kmp-android:1.0.0")

    // For Kotlin Multiplatform projects
    commonMain {
        dependencies {
            implementation("com.mojeter.ccgo:ccgonowdep-kmp:1.0.0")
        }
    }
}
```
...
println("Ccgonowdep version: $version")

// Get platform information
val platform = ccgonowdep.getPlatformName()
...
- `ccgonowdep-kmp/` - KMP metadata
- `ccgonowdep-kmp-android/` - Android target (if built)
- `ccgonowdep-kmp-androidnativedebug/` - Android Debug variant
- `ccgonowdep-kmp-androidnativerelease/` - Android Release variant
- `ccgonowdep-kmp-desktop/` - Desktop JVM target (Windows)
- `ccgonowdep-kmp-iosx64/` - iOS Simulator (Intel)
- `ccgonowdep-kmp-iosarm64/` - iOS Device (ARM64)
- `ccgonowdep-kmp-iossimulatorarm64/` - iOS Simulator (Apple Silicon)
- `ccgonowdep-kmp-macosx64/` - macOS (Intel)
- `ccgonowdep-kmp-macosarm64/` - macOS (Apple Silicon)
- `ccgonowdep-kmp-linuxx64/` - Linux (x86_64)
- `ccgonowdep-kmp-linuxarm64/` - Linux (ARM64)
...
|--------|-------------|---------|
| `getInstance()` | Get or create singleton | `CcgonowdepKMP` |
...
```swift
import CcgonowdepKMP

let lib = CcgonowdepKMP()
...
- **Header not found**: Verify header files exist in `../include/ccgonowdep/api/apple/` or `../include/ccgonowdep/api/native/`
...
- **Check library path**: Ensure `ccgonowdep.dll` is in:
...
This library is part of the Ccgonowdep project and follows the same license.
