...
#  include "ccgonow/api/ohos/ccgonow_napi.h"
...
static napi_value Init(napi_env env, napi_value exports) {
  napi_property_descriptor desc[] = {
    { "setDebugLog", nullptr, NapiCcgonowSetDebugLog, nullptr, nullptr, nullptr, napi_default, nullptr },
  };
...
// 模块定义
static napi_module ccgonowModule = {
  .nm_version = 1,
  .nm_flags = 0,
  .nm_filename = nullptr,
...
// 模块注册
extern "C" __attribute__((constructor)) void RegisterCcgonowModule(void) {
  napi_module_register(&ccgonowModule);
}
