...
> ccgonow 跨平台 C++ 库，支持 Android、iOS、macOS、Windows、Linux 和 OpenHarmony。

- [ccgonow - 仓库]( https://github.com/zhlinh/ccgonow )

- ccgonow README

  - [English]( https://github.com/zhlinh/ccgonow/blob/master/README.md )
  - [简体中文]( https://github.com/zhlinh/ccgonow/blob/master/README.zh-cn.md )

- ccgonow 文档

  - [English]( https://zhlinh-ccgonow.pages.github.com/ )
  - [简体中文]( https://zhlinh-ccgonow.pages.github.com/zh-cn/index.html )

## 1. 发布版本

发布版本见 [releases](https://github.com/zhlinh/ccgonow/-/releases)，版本变更记录见 [changelog](https://github.com/zhlinh/ccgonow/blob/master/CHANGELOG.md)

### 版本命名规则

- **Android SDK**: `CCGONOW_ANDROID_SDK-{版本号}-{发布类型}.aar`
- **iOS Framework**: `CCGONOW_IOS_FRAMEWORK-{版本号}-{发布类型}.zip`
- **macOS Framework**: `CCGONOW_MACOS_FRAMEWORK-{版本号}-{发布类型}.zip`
- **Windows 库**: `CCGONOW_WINDOWS_SDK-{版本号}-{发布类型}.zip`
- **Linux 库**: `CCGONOW_LINUX_SDK-{版本号}-{发布类型}.zip`
- **OpenHarmony HAR**: `CCGONOW_OHOS_SDK-{版本号}-{发布类型}.har`
...
**输出文件**:
- AAR 文件: `bin/android/CCGONOW_ANDROID_SDK-{版本号}-{发布类型}.aar`
- 归档包（含未 strip 的 .so）: `bin/android/ARCHIVE_CCGONOW_ANDROID_SDK-{版本号}-{发布类型}.zip`
...
**输出文件**:
- XCFramework: `bin/ios/CCGONOW_IOS_FRAMEWORK-{版本号}-{发布类型}.xcframework/`
- 归档包: `bin/ios/ARCHIVE_CCGONOW_IOS_FRAMEWORK-{版本号}-{发布类型}.zip`
...
**输出文件**:
- Framework: `bin/macos/CCGONOW_MACOS_FRAMEWORK-{版本号}-{发布类型}.framework/`
- 归档包: `bin/macos/ARCHIVE_CCGONOW_MACOS_FRAMEWORK-{版本号}-{发布类型}.zip`
...
**输出文件**:
- 库目录: `bin/windows/CCGONOW_WINDOWS_SDK-{版本号}-{发布类型}.dir/`
- 归档包: `bin/windows/ARCHIVE_CCGONOW_WINDOWS_SDK-{版本号}-{发布类型}.zip`
...
**输出文件**:
- 库目录: `bin/linux/CCGONOW_LINUX_SDK-{版本号}-{发布类型}.dir/`
- 归档包: `bin/linux/ARCHIVE_CCGONOW_LINUX_SDK-{版本号}-{发布类型}.zip`
...
**输出文件**:
- HAR 文件: `bin/ohos/CCGONOW_OHOS_SDK-{版本号}-{发布类型}.har`
- 归档包: `bin/ohos/ARCHIVE_CCGONOW_OHOS_SDK-{版本号}-{发布类型}.zip`
...
**范围**: `ccgonow|base|net|utils|build|docs|test`
